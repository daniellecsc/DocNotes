...
import { Mic, MicOff, Play, Pause, RotateCcw, Send, Edit, Loader2 } from "lucide-react"
    ...
    <Card>
      <CardHeader className="pb-4">
        <CardTitle className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          ...
          <Badge variant={stateInfo.variant} className="self-start sm:self-auto">
            {stateInfo.text}
          </Badge>
        </CardTitle>
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4">
                ...
                {!transcription && (
                  ...
                  >
                    ...
                    <span className="ml-2">{recordingState === "transcribing" ? "Transcribing..." : "Transcribe"}</span>
                  </Button>
                )}
              </div>
            </div>
          ...
          {recordingState === "idle" && !audioBlob && (
            <div className="text-center max-w-md mx-auto">
              <p className="text-sm text-muted-foreground leading-relaxed">
                Click the microphone button to start recording your session notes. Make sure your microphone is
