      ...
      <Card>
        ...
        <CardContent>
          <div className='text-center py-12 px-4'>
            <div className='mx-auto w-16 h-16 bg-cyan-200/40 rounded-full flex items-center justify-center mb-4'>
              <FileText className='h-8 w-8 text-dblue' />
            </div>
            <h3 className='text-lg font-medium text-foreground mb-2'>
              No session notes yet
            </h3>
            <p className='w-full text-sm text-muted-foreground mx-auto leading-relaxed'>
              Record your first audio note using the recorder above to get
              started with session documentation.
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <div className='space-y-4'>
            {notes.map((note) => {
              ...
              const isEdited =
                ...
                note.editedTranscription !== note.transcription;
        ...
        <DialogContent className='max-w-2xl mx-4 max-h-[90vh] overflow-y-auto'>
          <DialogHeader>
            ...
            <DialogDescription className='text-sm'>
              Make changes to your session note. The original transcription will
              be preserved.
            </DialogDescription>
          </DialogHeader>
          <div className='space-y-4'>
