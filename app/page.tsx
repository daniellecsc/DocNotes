    ...
    return (
      <div className="min-h-screen bg-background">
          ...
          <div className="max-w-4xl mx-auto px-4 py-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">Client Session Notes</p>
              </div>
              <Button
                variant="outline"
        ...
        <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="text-sm truncate">
                    {formatDate(selectedClient.dateOfBirth)} (Age {calculateAge(selectedClient.dateOfBirth)})
                  </span>
                </div>
                <div className="flex items-center gap-2 min-w-0">
          ...
          <NotesList key={notesKey} client={selectedClient} onNotesChange={handleNotesChange} />
        </div>
      </div>
    )
  }
      ...
      <div className="px-4 py-8 sm:py-12">
        <div className="max-w-6xl mx-auto">
          <div className="text-center sm:text-left mb-8 sm:mb-12">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-3 sm:mb-4">DocNotes</h1>
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl">
              Professional therapy session management with AI-powered transcription
            </p>
          </div>

          <div className="mb-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Select a Client</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {mockClients.map((client) => (
              <Card
                key={client.userId}
                className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:scale-[1.02] focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
              ...
              >
                <CardHeader className="pb-3">
                  <CardTitle className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    ...
                    <Badge variant="secondary" className="self-start sm:self-auto flex-shrink-0">
                      Age {calculateAge(client.dateOfBirth)}
                    </Badge>
                  </CardTitle>
                  <CardDescription className="text-xs sm:text-sm">Client ID: {client.userId}</CardDescription>
                </CardHeader>
